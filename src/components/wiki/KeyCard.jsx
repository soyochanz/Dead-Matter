        ...
        >
            ...
            <div className={`relative h-full bg-[#08080a] rounded-[2.2rem] border border-white/5 overflow-hidden transition-all duration-500 group-hover:border-white/20 shadow-2xl`}>
                ...
                <div className="relative flex flex-col h-full pt-8">
                    <div className="relative h-56 w-full flex items-center justify-center p-8 group-hover:p-6 transition-all duration-700 overflow-hidden">
                            ...
                            <div className="pt-6 border-t border-white/5 mt-auto">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center px-1">
                                        <span className="text-[8px] font-black text-white/20 uppercase tracking-widest">AUTHENTICATION</span>
                                        <span className="text-[11px] font-bold text-white/80">VALIDATED</span>
                                    </div>
