...
const ToolbeltCard = ({ item, index, onClick }) => {
    ...
    const primaryStat = { label: 'Slots', value: item.inventory_slots || 0 };
    const secondaryStat = { label: 'Weight', value: item.weight || 0 };
                            ...
                            <div className="grid grid-cols-2 gap-6 pt-6 border-t border-white/5 mt-auto">
                                <div className="space-y-2">
                                    ...
                                    <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
                                        <motion.div 
                                            initial={{ width: 0 }}
                                            animate={{ width: `${Math.min((primaryStat.value / 20) * 100, 100)}%` }}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
                                        <motion.div 
                                            initial={{ width: 0 }}
                                            animate={{ width: `${Math.min(secondaryStat.value * 10, 100)}%` }}
                                            transition={{ duration: 1, ease: "easeOut" }}
