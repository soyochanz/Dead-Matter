...
const ConsumableCard = ({ consumable, index, onClick }) => {
    ...
    const rarity = consumable.rarity?.name || 'Common';
    const style = getRarityStyles(rarity);

    const primaryStat = { label: 'Hydration', value: consumable.hydration || 0 };
    const secondaryStat = { label: 'Energy', value: consumable.energy || 0 };
