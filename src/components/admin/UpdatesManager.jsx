          ...
          {items.map(item => (
            <div key={item.id} className="bg-white/5 border border-white/10 rounded-lg p-4 flex justify-between items-start gap-4">
              <div className="flex-1 min-w-0">
                ...
                <div 
                  className="prose prose-sm prose-invert max-h-24 overflow-hidden relative text-gray-300 before:content-[''] before:absolute before:inset-x-0 before:bottom-0 before:h-8 before:bg-gradient-to-t before:from-white/5"
